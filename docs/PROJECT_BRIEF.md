        ...
        result-ts exists to solve a narrow, inspectable developer-tooling problem:
        Type-safe Result<T, E> with map/flatMap/unwrap/all/any/partition/tryCatch/fromPromise/fromNullable combinators.
        ...
        Topics: functional, monad, result, typescript, zero-dependencies
